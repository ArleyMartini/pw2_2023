    ...
    try {
        ...
        if ($usuario != null) {
            ...
            if (password_verify($senha, $usuario['senha'])) {
                ...
                // Senha inválida
                $_SESSION['mensagem'] = "Senha inválida. Por favor, tente novamente.";
            }
        } else {
            // Usuário não encontrado
            $_SESSION['mensagem'] = "Usuário não encontrado. Por favor, tente novamente.";
        }
    } catch (PDOException $e) {
        $_SESSION['mensagem'] = "Erro ao realizar o login: " . $e->getMessage();
    }
}
    ...
    public function update(Usuario $usuario)
{
    ...
    public function findById($id)
    {
        try {
            ...
            $_SESSION['mensagem'] = "Erro ao buscar o usuário: " . $e->getMessage();
        }
    }
}
